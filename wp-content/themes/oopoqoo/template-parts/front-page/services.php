                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo esc_url( get_post_permalink( $featured_page_1 ) ); ?>" class="btn btn-primary"><?php esc_html_e( 'Read More', 'oopoqoo' ); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo esc_url( get_post_permalink( $featured_page_2 ) ); ?>" class="btn btn-primary"><?php esc_html_e( 'Read More', 'oopoqoo' ); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo esc_url( get_post_permalink( $featured_page_3 ) ); ?>" class="btn btn-primary"><?php esc_html_e( 'Read More', 'oopoqoo' ); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
