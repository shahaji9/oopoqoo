...
WP_Bootstrap_4_Kirki::add_panel( 'theme_options', array(
    'priority'    => 31,
    'title'       => esc_html__( 'Theme Options', 'oopoqoo' ),
) );

WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	'settings' => 'logo_height',
	'label'    => esc_html__( 'Logo Height (in px)', 'oopoqoo' ),
	'section'  => 'title_tagline',
	'type'     => 'number',
	'priority' => 8,
	'default'  => 60,
    'tooltip'  => esc_html__( 'Minimum height 25px & maximum height 200px. Width will be adjusted automatically.', 'oopoqoo' ),
    'choices'  => array(
		'min'  => 25,
		'max'  => 200,
		'step' => 1,
...
WP_Bootstrap_4_Kirki::add_section( 'upgrade_theme', array(
    'title'          => esc_html__( 'Get More Features', 'oopoqoo' ),
    'panel'          => '',
    'capability'     => 'edit_theme_options',
    'theme_supports' => '',
	'priority'		 => 500
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'type'     => 'custom',
    'default'  => '<h2 class="wp-bp-region-title first-region-title">' . esc_html__( 'Upgrade To Pro', 'oopoqoo' ) . '</h2>
					<p>Let\'s make your website even better with the pro version of this theme.</p>
					<a class="button button-primary button-hero" href="https://bootstrap-wp.com/downloads/oopoqoo-pro/" target="_blank">Read More</a>',
) );
...
function wp_bootstrap_4_customizer_css()
{
	if( class_exists( 'Kirki' ) ) {
		wp_enqueue_style( 'oopoqoo-customizer-css', get_template_directory_uri() . '/inc/theme-options/customizer.css' );
	}
}
