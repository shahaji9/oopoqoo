...
WP_Bootstrap_4_Kirki::add_section( 'blog_home', array(
    'title'          => esc_html__( 'Blog Homepage', 'oopoqoo' ),
    'panel'          => 'theme_options',
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'section'  => 'blog_home',
	'type'     => 'custom',
    'default'  => '<h2 class="wp-bp-region-title first-region-title">' . esc_html__( 'Cover Section', 'oopoqoo' ) . '</h2>',
) );

WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	'settings' => 'blog_display_cover_section',
	'label'    => esc_html__( 'Display Cover Section', 'oopoqoo' ),
	'section'  => 'blog_home',
	'type'     => 'checkbox',
    'default'  => 1,
) );
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'             => esc_html__( 'Cover Lead Text', 'oopoqoo' ),
	'section'           => 'blog_home',
	'type'              => 'text',
) );
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'section'  => 'blog_home',
	'type'     => 'custom',
    'default'  => '<h2 class="wp-bp-region-title">' . esc_html__( 'Featured Posts Slider', 'oopoqoo' ) . '</h2>',
) );

WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	'settings' => 'blog_display_posts_slider',
	'label'    => esc_html__( 'Display Posts Slider', 'oopoqoo' ),
	'section'  => 'blog_home',
	'type'     => 'checkbox',
    'default'  => 1,
) );
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Number of Posts In Slider', 'oopoqoo' ),
	'section'  => 'blog_home',
	'type'     => 'number',
    'default'  => '5',
    'choices'  => array(
...
if( class_exists( 'Kirki_Helper' ) ) {
    WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
    	...
    	'label'       => esc_html__( 'Select Posts', 'oopoqoo' ),
    	'section'     => 'blog_home',
    	'type'        => 'select',
        'multiple'    => 10,
