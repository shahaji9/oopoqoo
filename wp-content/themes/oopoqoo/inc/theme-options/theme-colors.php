...
if( class_exists( 'Kirki' ) ) {
    function wp_bootstrap_4_colors_section( $wp_customize ) {
        $wp_customize->get_control( 'background_color' )->label = esc_html__( 'Body Background Color', 'oopoqoo' );
        $wp_customize->get_section( 'colors' )->title = esc_html__( 'Theme Colors', 'oopoqoo' );
    }
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Header Background Color', 'oopoqoo' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#343a40',
    'output'   => array(
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'section'  => 'colors',
	'type'     => 'color',
    'label' => esc_html__( 'Links & Buttons Color', 'oopoqoo' ),
    'default'  => '#007bff',
    'output'   => array(
        array(
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Links & Buttons Hover Color', 'oopoqoo' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#0069d9',
    'output'   => array(
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Footer Background Color', 'oopoqoo' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#ffffff',
    'output'   => array(
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Footer Text Color', 'oopoqoo' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#6c757d',
    'output'   => array(
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Footer Link Color', 'oopoqoo' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#007bff',
    'output'   => array(
